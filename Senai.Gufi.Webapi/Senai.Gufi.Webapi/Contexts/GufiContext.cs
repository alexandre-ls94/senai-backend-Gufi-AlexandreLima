...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=DEV22\\SQLEXPRESS; Initial Catalog=Gufi_Manha; User=sa; Pwd=sa@132;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Instituicao>(entity =>
            {
                ...
                entity.HasIndex(e => e.Cnpj)
                    .HasName("UQ__Institui__AA57D6B49E83E934")
                    .IsUnique();

                entity.HasIndex(e => e.Endereco)
                    .HasName("UQ__Institui__4DF3E1FF4348F12F")
                    .IsUnique();

                entity.HasIndex(e => e.NomeFantasia)
                    .HasName("UQ__Institui__F5389F3182F34CEF")
                    .IsUnique();
            ...
            modelBuilder.Entity<TipoEvento>(entity =>
            {
                ...
                entity.HasIndex(e => e.TituloTipoEvento)
                    .HasName("UQ__TipoEven__40023AD26237D213")
                    .IsUnique();
            ...
            modelBuilder.Entity<TipoUsuario>(entity =>
            {
                ...
                entity.HasIndex(e => e.TituloTipoUsuario)
                    .HasName("UQ__TipoUsua__37BBE07E06D96090")
                    .IsUnique();
            ...
            modelBuilder.Entity<Usuario>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email)
                    .HasName("UQ__Usuario__A9D105347AE26DDA")
                    .IsUnique();
